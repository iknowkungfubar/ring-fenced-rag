...
```bash
pytest tests/ -v --tb=short --cov=src/rfr
```
...
Open a [Discussion](https://github.com/iknowkungfubar/ring-fenced-rag/discussions) or an [Issue](https://github.com/iknowkungfubar/ring-fenced-rag/issues) with a clear description of what you need help with.
