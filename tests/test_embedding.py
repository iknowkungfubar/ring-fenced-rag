...
class TestLocalEmbeddings:
    ...
    def test_embed_query_returns_list_of_floats(self, embeddings: Any) -> None:  # noqa: ANN401
    ...
    def test_embed_documents_returns_list_of_vectors(self, embeddings: Any) -> None:  # noqa: ANN401
    ...
    def test_embedding_dimension_matches_model(self, embeddings: Any) -> None:  # noqa: ANN401
    ...
    def test_different_texts_different_vectors(self, embeddings: Any) -> None:  # noqa: ANN401
    ...
    def test_same_text_same_vector(self, embeddings: Any) -> None:  # noqa: ANN401
